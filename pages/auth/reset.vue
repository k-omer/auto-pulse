      ...
      <v-row justify="center" align="center" class="min-vh-100">
        <v-col cols="12" sm="8" md="6" lg="4" xl="3">
          ...
          <div class="glass-auth-card">
            <div class="auth-header mb-8">
              <div class="reset-icon mb-4">
                <v-icon icon="mdi-lock-reset" size="48" color="primary"></v-icon>
              </div>
            ...
            <v-form class="auth-form">
              ...
              <v-btn
                ...
                rounded="xl"
                block
                class="magic-btn reset-btn mb-8"
              >
                <v-icon start icon="mdi-email-send"></v-icon>
                Send Reset Link
              </v-btn>

              <!-- Success Message (shown after submission) -->
              <div class="success-message mb-6" v-if="showSuccess">
          ...
          <div class="help-section mt-8">
            <div class="help-item">
              <v-icon icon="mdi-help-circle" size="16" color="info"></v-icon>
              <span>Can't access your email? <a href="#" class="help-link">Contact support</a></span>
            </div>
            <div class="help-item">
              <v-icon icon="mdi-clock" size="16" color="info"></v-icon>
